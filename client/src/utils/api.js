...
export const registrationAPI = {
  ...
  exportHackathonEvaluation: (workshopId) => axios.get(`${API_URL}/registrations/hackathon/${workshopId}/evaluation/export`, {
    headers: getAuthHeaders(),
    responseType: 'blob'
  }),
...
export const attendanceAPI = {
  ...
  deleteHackathonSession: (workshopId, sessionId) => axios.delete(`${API_URL}/attendance/hackathon/${workshopId}/sessions/${sessionId}`, { headers: getAuthHeaders() }),
  ...
  postFromEntry: (workshopId, data) => axios.post(`${API_URL}/attendance/workshop/${workshopId}/from-entry`, data, {
    headers: getAuthHeaders()
  }),
