...
export const BlogsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 pt-28 lg:pt-16">
      <div className="fixed left-0 right-0 top-0 z-[900] bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm">
