...
const getTeamName = (registration) => {
  return registration.teamCode || 'Team';
};
        ...
        {error ? (
          ...
          <>
            <section className="leaderboard-hero">
              ...
              <p>Rankings are published only after admin approval.</p>
            </section>
              ...
              <div className="mt-6 grid gap-4">
                {remainingTeams.map((registration, index) => (
                  <div
                    ...
                    style={{ '--score-width': `${Math.max(8, 100 - (index * 8))}%` }}
                  >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="leaderboard-score">
                        <p className="text-xs font-black uppercase tracking-wide text-primary">Rank</p>
                        <p className="text-3xl font-black">#{index + 4}</p>
                      </div>
                    </div>
